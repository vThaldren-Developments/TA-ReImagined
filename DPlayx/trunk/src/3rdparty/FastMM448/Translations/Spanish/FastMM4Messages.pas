...
const
  ...
  CurrentStackTraceMsg = #13#10#13#10'Traza del stack que concluyó en este error (direcciones de retorno): ';
  {Memory dump message}
  ...
  MemoryAllocatedMsg =
    ...
    'Si está utilizando un interceptor de excepciones como MadExcept (o cualquier otra herramienta que modifique el orden de inicialización de las units),'#13#10
